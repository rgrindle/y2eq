...
ff_list = pd.read_csv('01_predicted_ff_weights.csv', header=None).values.flatten()
...
pd.DataFrame([rmse_int_list, rmse_ext_list]).T.to_csv('02_rmse_weights.csv', index=False, header=['rmse_int', 'rmse_ext'])
