...
PURPOSE: Train xy2eq or y2eq with all 1000 x-values used in
         each generation.
...
TODO:
"""
from train_all1000 import train
...
train(args.epochs, train_loader, valid_loader,
      ...
      save_end_name='_all1000_{}_batchsize{}_lr{}_clip{}_layers{}_{}'.format(args.dataset.replace('.pt', ''), args.batch_size, args.lr, args.clip, args.layers, epochs_filename))
