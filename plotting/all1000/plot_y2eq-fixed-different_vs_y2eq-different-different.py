...
rmse_y2eq_fixed_different = pd.read_csv('../../../eval_y2eq-fixed-different-1000/02_rmse.csv', header=None).values
...
plt.xscale('log')
plt.ylim([0, 1000])
plt.savefig('018_fig1_interpolation_all1000.pdf')

plt.xscale('linear')
plt.xlim([0, 3])
plt.savefig('018_fig1_zoom_interpolation_all1000.pdf')
