...
NOTES: i (first number in each element of ind_list)
       should actual start at one not at zero. Currently,
       this is fixed by adding one to i in the 02 script,
       but if I ever need to run this script again I should
       update i in both scripts for clarity.
