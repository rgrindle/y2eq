...
if __name__ == '__main__':
    ...
    plt.xscale('log')
    plt.ylim([0, 1])
    plt.savefig('03_eval_xy2eq-different-different_ymax1.pdf')
    ...
    plt.legend()
    plt.xscale('log')
    plt.savefig('03_eval_xy2eq-different-different_ymaxauto.pdf')
    ...
    plt.scale('linear')
    plt.legend()
    plt.savefig('03_eval_xy2eq-different-different.pdf')
