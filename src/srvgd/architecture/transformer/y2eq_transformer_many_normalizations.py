...
y2eq_trans_model = y2eqTransformer(src_input_size=2,
...
if __name__ == '__main__':
    ...
    # Get dataset
    dataset_name = 'dataset_train_ff1000_many_normalizations.pt'
    ...
    train_many_epochs(train_iterator=train_iterator,
                      ...
                      device=device,
                      model_name='y2eq_transformer_many_normalizations.pt')
