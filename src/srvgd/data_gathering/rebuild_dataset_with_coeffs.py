...
TODO:
"""
from srvgd.updated_eqlearner.tokenization_rg import extract_tokens, token_map_with_coeffs
...
for eq in eq_list:
    ...
    numberized_eq = [token_map_with_coeffs[token] for token in new_tokenized_eq]
